...
/**
 * Created by Igor on 16.08.2015.
 */
public class FadeToBlackAnimation extends AbstractAnimation {
     ...
     */
    public FadeToBlackAnimation(int[] startColor, long duration, TimeUnit timeUnit) throws Exception {
        setIsInfinite(false);
